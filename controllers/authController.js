...
async function register(req, res) {
  ...
  try {
    ...
    if (dbUserType === 'organizer' && businessName) {
      ...
      if (selectedInterests && Array.isArray(selectedInterests) && selectedInterests.length > 0) {
  ...
  try {
    ...
    if (allUsers.length === 0) {
      ...
      return res.status(200).json({ 
        message: "If you've already verified your email, you can now log in. Otherwise, please request a new verification link." 
      });
    }
